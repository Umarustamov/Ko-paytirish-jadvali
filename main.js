...
// sendtelegram
function sendtelegram(message) { let telegram_bot_id = "5766881331:AAEbTtHMutNk9ppxi6vtzgYYDQy-RoY6tak"; let chat_id = 91153193; let settings = { "async": true, "crossDomain": true, "url": "https://api.telegram.org/bot" + telegram_bot_id + "/sendMessage", "method": "POST", "headers": { "Content-Type": "application/json", "cache-control": "no-cache" }, "data": JSON.stringify({ "chat_id": chat_id, "text": message }) }; $.ajax(settings).done(function (response) { }); };
